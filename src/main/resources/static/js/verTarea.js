document.addEventListener('DOMContentLoaded', function() {
    ...
    buttons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            openModal(nombre, estado, descripcion, dia, subgrupo, monitor);
        });
    });
});

function openModal(nombre, estado, descripcion, dia, subgrupo, monitor) {
    ...
    document.getElementById('modalTareaSubGrupo').textContent = 'Subgrupo: ' + subgrupo;
